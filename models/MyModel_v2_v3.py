...
class GCN(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_classes, num_edges,
...
class MyModel(nn.Module):
    def __init__(self, backbone, dim, num_classes, last_size, num_heads, batch_size,
        ...
        self.gcn = GCN(in_channels=dim_sum, hidden_channels=dim_sum,
                       ...
                       num_edges=batch_size * gcn_p * (gcn_p - 1) * 2)
